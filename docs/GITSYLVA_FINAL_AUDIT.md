...
- Notificação com vinha decorativa (design 6.16), Gravatar/email (H20), DnD/cor de grupos (R14), caminho longo Windows >260 (R13), packaging (`tauri build` bundle) por executar.
