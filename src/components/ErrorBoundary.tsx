...
// Top-level safety net: a render error in any screen shows a recoverable
...
export class ErrorBoundary extends Component<Props, State> {
  ...
  render() {
    if (this.state.error) {
      return (
        <div style={{ height: "100%", display: "grid", placeItems: "center", background: "var(--win, #141618)", color: "var(--text, #EAECEE)" }}>
